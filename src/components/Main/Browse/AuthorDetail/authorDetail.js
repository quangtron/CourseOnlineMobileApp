      ...
      {authorContext.state.author ? (
        <View style={styles.mainStyle}>
          ...
          <View style={styles.section}>
            <Text style={Styles.text(16, "#000", "bold")}>{language ? 'Introduction' : 'Giới thiệu'}</Text>
          ...
          <View style={styles.section}>
            <Text style={Styles.text(16, "#000", "bold")}>{language ? 'Skills' : 'Kỹ năng'}</Text>
          ...
          <SectionCourses
            ...
            title={language ? 'COURSES OF TEACHER' : "KHOÁ HỌC CỦA GIẢNG VIÊN"}
          />
        </View>
      ) : (
        <ActivityIndicator />
